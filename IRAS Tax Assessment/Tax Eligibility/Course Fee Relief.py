CFR ='''Course Fees Relief is given to encourage individuals to continuously upgrade their skills and enhance employability
...
x = input('Would you like to see a detailed description of the Course Fee Tax Relief? Y/N: ')
if x.upper() == 'Y':
    print(CFR)
...
while True:
    try:
        ...
        if duration == 1:
            course_expense = int(input('Enter the total expense incurred by the course/study/seminar/conference applicable($):\n '))
